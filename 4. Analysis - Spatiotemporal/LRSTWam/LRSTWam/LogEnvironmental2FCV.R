...
RunAlgorithm<- function(dataParentDirectory, exportDirectoryLoocv) {
    ...
    modelPerformanceFilePath <- file.path(exportDirectoryLoocv, "log_environmental_2fcv.csv")
...
Main <- function() {
    ...
    exportDirectoryForModel <- file.path(exportDirectory, "LOGEnvironmental2FCV")
