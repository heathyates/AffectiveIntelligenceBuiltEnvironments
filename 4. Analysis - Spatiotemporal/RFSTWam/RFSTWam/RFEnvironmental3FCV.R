...
RunAlgorithm<- function(dataParentDirectory, exportDirectoryLoocv) {
    ...
    modelPerformanceFilePath <- file.path(exportDirectoryLoocv, "rf_environmental_3fcv.csv")
...
Main <- function() {
    ...
    exportDirectoryForModel <- file.path(exportDirectory, "RFEnvironmental3FCV")
