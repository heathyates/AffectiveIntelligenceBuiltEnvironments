...
RunAlgorithm<- function(dataParentDirectory, exportDirectoryLoocv) {
    ...
    modelPerformanceFilePath <- file.path(exportDirectoryLoocv, "nn_environmental_3fcv.csv")
...
Main <- function() {
    ...
    exportDirectoryForModel <- file.path(exportDirectory, "NNEnvironmental3FCV")
